...
namespace polymorphism_1._11
{
    class Program
    {
        ...
        public static void runApp()
        {
            ...
            Console.WriteLine("total marks in Elementary school =" +
            ...
            middle.Geography = 87;
            middle.History = 76;
            Console.WriteLine("total marks in Middle School =" + middle.getTotalMarks());
            ...
            high.Chemistry = 76;
            high.Biology = 70;
            Console.WriteLine("total marks  in High School=" + high.getTotalMarks());
        }
    }
}
